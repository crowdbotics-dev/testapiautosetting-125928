...
## Project Structure
    ...
    ├── testapiautosetting_125928  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125928`
...
2. Clone this repo and `cd testapiautosetting_125928`
